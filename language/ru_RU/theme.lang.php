...
$lang['Hides the top menu and jumbotron containing the page title and banner'] = 'Скрыть верхнее меню и jumbotron, содержащий заглавие страницы и баннер';
$lang['Show a jumbotron banner on the categroy pages.'] = 'Показ баннера jumbotron на странице категорий.';
$lang['A mobile-ready theme based on Boostrap Default'] = 'Мобильная тема основана на Boostrap  по умолчанию';
...
$lang['Always'] = 'Всегда';
$lang['Never'] = 'Никогда';
$lang['For more information on metadata visit'] = 'Для получения дополнительной информации о метаданых перейдите ';
...
$lang['Bug reports and features requests'] = 'Отчет об ошибках и запросы';
...
$lang['Infinite looping'] = 'Зацикливание';
$lang['Issue tracker'] = 'Система отслеживания проблем';
$lang['Picture details page'] = 'Информация о деталях изображения';
...
$lang['No color theme'] = 'Бесцветная тема';
...
$lang['Tabs below the image'] = 'Вкладка под изображением';
$lang['directly in the navigation bar'] = 'непосредственно в панели навигации';
$lang['loads all images one after another when the page loads (use carefully!)'] = 'загружаются все изображения один за другим, при загрузке страницы (используйте осторожно!)';
$lang['will load the image as soon as you slide to it'] = 'загружается изображение, как только Вы проведете над ним мышкой';
$lang['lazyLoad method'] = 'метод lazyLoad';
...
$lang['Based on Bootstrap Default by'] = 'Основано на теме по умолчанию';
